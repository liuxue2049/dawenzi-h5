...
const PROPS = {
  ...
  4: { speed: 1.0, maxHealth: 100, attackDamage: 12, attackInterval: 3500, attack: true, heal: true },
...
export default class Die extends Sprite {
  constructor(type = 1) {
    super();
  ...
  render(ctx) {
    ...
    else { ctx.fillStyle = '#FF69B4'; ctx.fillRect(this.x, this.y, this.width, this.height); ctx.fillStyle = '#fff'; ctx.font = '10px Arial'; ctx.textAlign = 'center'; ctx.fillText(`B${this.mosquitoType}`, this.x + this.width / 2, this.y + this.height / 2 + 4); }
